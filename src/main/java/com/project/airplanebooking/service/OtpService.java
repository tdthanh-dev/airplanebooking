...
// Optional<OtpEntity> existingOtp =
...
// {
// throw new BadRequestException("Vui lòng đợi 1 phút trước khi yêu cầu OTP
// mới");
// }
...
// " + OTP_EXPIRY_MINUTES + " phút.";
// emailService.sendEmail(email, subject, body);
// }

// public boolean verifyOtp(String email, String otp) {
// OtpEntity otpEntity = otpRepository.findByEmailAndOtpAndUsedFalse(email, otp)
// .orElseThrow(() -> new BadRequestException("Mã OTP không hợp lệ hoặc đã hết
// hạn"));
